...
const DiscoverOtherTopics = () => {
    return (
        <div className="discoverOthersStyle py-2">
            ...
            <div className="blog p-2 mb-2 ">
                <h4 className="title josefin-sans-bolder">
            ...
            <div className="blog p-2 mb-2 ">
                ...
                <div className="d-flex publisher justify-content-start align-items-center">
                    <img className="rounded-circle" src="https://picsum.photos/200/300" />
                    <p className="mb-0 ms-2 name text-truncate">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, magni
                        debitis. Magni?
                    </p>
                </div>
            </div>
            <div className="blog p-2 mb-2 ">
                <h4 className="title josefin-sans-bolder">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati rerum nihil
                    nam aliquid?
                </h4>
                <div className="d-flex publisher justify-content-start align-items-center">
                    <img className="rounded-circle" src="https://picsum.photos/200/300" />
